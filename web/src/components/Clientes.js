...
const Clientes = () => {
  ...
  const handleSaveCliente = () => {
    axios.post("http://localhost:5075/Cliente/nuevo", infoCliente)
    .then(({data}) => {
        ...
        <Paper elevation={3} sx={{ p: 4 }}>
            ...
            {!clientes.length ? (
              <>
                ...
                <Grid2 md={12} xs={12} sx={{ textAlign: "center" }}>
                  <Typography variant="button">No hay clientes registrados</Typography>
                </Grid2>
              </>
            ) : (
          ...
          <Grid2 container spacing={3} sx={{pt: 4}} >
            ...
            <Grid2 md={3} xs={12} sx={{ pt: 2 }}>
                ...
                <Grid2 md={3} xs={12} sx={{ pt: 2 }}>
                  <Button onClick={handleSaveCliente} variant="contained" fullWidth sx={{height: "100%"}}>Registrar Cliente</Button>
                </Grid2>
          </Grid2>
        </Paper>
      </Grid2>
